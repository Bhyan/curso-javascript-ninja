(function (){
    ...
    */
    ...
    var name = ['bry', 'an'];
    var pName = name.reduce(function(acumulado, item){
    ...
    */
    ...
    exist > -1 ? console.log("Existe um objeto { number: 2 } em numberObjects!") :
    ...
    */
    ...
    var exist = numberObjects.lastIndexOf({ number: 2 });
    exist > -1 ? console.log("Existe um objeto { number: 2 } em numberObjects!") :
                    console.log("Não existe um objeto { number: 2 } em numberObjects :(");
    /*
    ...
    */
    ...
    isArray ? console.log(justMod2Or3.toString()) : console.log(justMod2Or3);
