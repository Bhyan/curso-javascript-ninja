(function(){
    ...
    */
    var nordeste = ['Alagoas', 'Bahia', 'Ceará', 'Maranhão', 'Paraíba', 'Pernambuco', 'Piauí',
    ...
    */
    ...
    var every = brasil.every(function(item, index, array){
    ...
    */
    ...
    var ceara = brasil.some(function(item, index, array){
        return item == 'Ceará';
    });
