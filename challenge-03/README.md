...
*/
pessoa.nomeCompleto(); // 'Olá! Meu nome é Bryan Brito !'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostarPeso(); // 'Eu peso 97Kg.'
...
pessoa.apresentacao = function(){
    ...
    var metro = pessoa.caminhouQuantosMetros > 1 ? 'metros' : 'metro';
    
    return 'Olá, eu sou ' + sexo + ' ' + pessoa.nome + ' ' + pessoa.sobrenome + ' , tenho ' + pessoa.idade + '  '
    + idade + ', ' + pessoa.altura + ', meu peso é ' + pessoa.peso + ' e, só hoje, eu já caminhei ' +   
